...
var Application = (function (_super) {
    ...
    Application.preload = function() {
        ...
        async.series([
            ...
            self.tableView = new FruitMainView();
        });
    };
    ...
    Application.runTableView = function() {
        this.runView(this.tableView);
        this.state = Application.STATE_RUNNING;
    };

    Application.runDoubleView = function() {
        this.runView(this.doubleView);
        this.state = Application.STATE_RUNNING;
    };
